...
public class AddEngImages extends AppCompatActivity {
    TextView tv_save_next;
    public RecyclerView rv_eng_imagelist;
    public AdapterEngineImages adapterEngineImages;
    ...
    private static AddEngImages instance;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_eng_images);
        ...
        SPHelper.saveSPdata(AddEngImages.this, SPHelper.imagestaken, "");
        ...
        AWSMobileClient.getInstance().initialize(AddEngImages.this).execute();
        credentials = new BasicAWSCredentials(SPHelper.getSPData(AddEngImages.this,SPHelper.awskey,""), SPHelper.getSPData(AddEngImages.this,SPHelper.awssecret,""));
        s3Client = new AmazonS3Client(credentials);
        apiInterface = ApiClient.getClient().create(MechanicApis.class);
        progressDialog = new ProgressDialog(AddEngImages.this);
        ...
        /*rv_eng_imagelist.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (engineImages.get(position).getImage() == null)
                {
                    ...
                    // CallCameracar();
                   *//* AddEngImages.ImageUploadOptionsPop yourDialog = new AddEngImages.ImageUploadOptionsPop();
                    yourDialog.activity = AddEngImages.this;
    ...
    void openCamera()
    {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            imageUri = FileProvider.getUriForFile(AddEngImages.this,
    ...
    {
        mRequestPermissionHandler.requestPermission(AddEngImages.this, new String[]
                {
...
//        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, this);
    ...
    public void Upload_after_check()
    {
        ...
        if (mDialog == null) {
            mDialog = new ProgressDialog(AddEngImages.this);
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        SPHelper.saveSPdata(AddEngImages.this, SPHelper.imagestaken, uploadImages.toString());
                        checkupload();
                    }
                });
            }
    ...
    {
        if (!Connectivity.isNetworkConnected(AddEngImages.this)) {
            Toast.makeText(AddEngImages.this, "Please check your Internet Connection", Toast.LENGTH_SHORT).show();
            return;
        }
        if (SPHelper.getSPData(AddEngImages.this, SPHelper.imagestaken, "").trim().length() > 0) {
            try {
                JSONArray images = new JSONArray(SPHelper.getSPData(AddEngImages.this, SPHelper.imagestaken, ""));
            ...
            Toast.makeText(AddEngImages.this, "Please capture all 4 images", Toast.LENGTH_SHORT).show();
                ...
                try {
                    if (!isServiceRunning)
                    {
                        if (!Connectivity.isNetworkConnected(AddEngImages.this)) {
                            ...
                            AlertDialog.Builder builder1 = new AlertDialog.Builder(AddEngImages.this);
        ...
        try {
            final TransferUtility transferUtility =
                    TransferUtility.builder()
                            ...
                            .s3Client(s3Client)
                            .build();
            final String key = "Test_Dealer_EngineImage/" +SPHelper.getSPData(AddEngImages.this, SPHelper.dealerid, "")+ uri.getLastPathSegment();
    ...
    public  void get_engineimagelist()
    {
        {
            if (!Connectivity.isNetworkConnected(AddEngImages.this)) {
                    ...
                    public void onResponse(@NotNull Call<AppResponse> call, @NotNull Response<AppResponse> response) {
                        ...
                        if (response.body() != null)
                        {
                            if (response_code.equals("200"))
                            {
                                ...
                                adapterEngineImages = new AdapterEngineImages(engineImages,AddEngImages.this);
                                LinearLayoutManager linearLayoutManager=new LinearLayoutManager(AddEngImages.this,RecyclerView.VERTICAL,false);
                                rv_eng_imagelist.setLayoutManager(linearLayoutManager);
                                rv_eng_imagelist.setAdapter(adapterEngineImages);
                                AddEngImages.this.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        adapterEngineImages.notifyDataSetChanged();
                                    }
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AddEngImages.this, "internal server error", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    public void add_engine_images()
    {
        JSONObject params = new JSONObject();
        try {
            params.put("dealerId", SPHelper.getSPData(AddEngImages.this,SPHelper.dealerid,""));
            params.put("vehicleId",SPHelper.vehid);
            params.put("moduleId", SPHelper.moduleid);
            params.put("addedBy", SPHelper.getSPData(AddEngImages.this,SPHelper.employeeid,""));
            params.put("isImg", "Y");
        ...
        new WebService().LoadwithUrl(AddEngImages.this, ServiceURL.BASEURL, WebService.HttpMethod.post, null, WebService.RequestType.shared.REST(ServiceURL.add_engine_images, WebService.RESTType.JSONBody, params), true, 0, new ResponseListener() {
            @Override
            public void ResponseSuccess(ResponseExtension response) {
                if (response.getResponseType().equalsIgnoreCase("200")) {
                    ...
                    try {
                        ...
                        Toast.makeText(AddEngImages.this, "Images added successfully", Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(AddEngImages.this,SubmitVehInspection.class);
                    ...
                    isServiceRunning=false;
                    progressDialog.dismiss();
                    Toast.makeText(AddEngImages.this, response.getResponseMessage(), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public static AddEngImages getInstance() {
        return instance;
    }
